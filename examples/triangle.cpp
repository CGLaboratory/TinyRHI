...
int main()
{
    ...
    if (!surface.create("TinyRHI Triangle", 960, 540, instance->getWindowRequirements())) {
    ...
    const Vertex vertices[] = {
        {{0.0f, 0.6f, 0.0f}, {0.95f, 0.25f, 0.25f, 1.0f}},
        {{-0.65f, -0.55f, 0.0f}, {0.2f, 0.75f, 0.35f, 1.0f}},
        {{0.65f, -0.55f, 0.0f}, {0.2f, 0.45f, 1.0f, 1.0f}},
    };
